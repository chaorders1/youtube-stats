...
Example:
    ...
    python youtube_csv_validator.py --input_file "/Users/mac_mini/code/youtube-top-10000-channels/src/utils/youtube_channel_urls_web_part3.csv" --url_column "Youtube_Channel_URL" --limit 100
'''
